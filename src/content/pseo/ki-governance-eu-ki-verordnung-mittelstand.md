---
title: "KI-Governance im Mittelstand: Was die EU-KI-Verordnung konkret verlangt und wie Sie sie ohne Rechtsabteilung erfüllen"
keyword: "ki governance"
intent: "Geschäftsführer sind sich bewusst, dass die EU-KI-Verordnung seit 2025 gestaffelt in Kraft tritt. Sie suchen einen praktikablen Rahmen für die Pflichten, der ohne eigene Compliance-Abteilung funktioniert und sich nicht als 80-Seiten-Handbuch tarnt."
cluster: "compliance"
description: "KI-Governance für den Mittelstand: Timeline der EU-KI-VO-Pflichten 2025 bis 2027, Strafrahmen bis 35 Mio €, vier Risikoklassen und ein praktikabler Governance-Rahmen ohne Rechtsabteilung."
bafa_badge: true
content_format: "prose"
roi_data:
  metric: "Maximaler Strafrahmen bei Verstoß gegen verbotene Praktiken nach Artikel 5 EU-KI-VO"
  value: "bis zu 35 Millionen Euro oder 7% weltweiter Jahresumsatz"
  source: "Verordnung (EU) 2024/1689, Artikel 99"
savings_range:
  min: 25000
  max: 300000
  unit: "euro_per_year"
approach_steps:
  - title: "Inventur aller eingesetzten KI-Systeme"
    text: "Wir erfassen jedes KI-System im Betrieb, auch versteckte Module in Branchensoftware. Das Ergebnis ist ein Register, das als Grundlage für die Risikoklassifizierung nach Artikel 6 dient. Ohne dieses Register sind alle weiteren Pflichten nicht erfüllbar."
  - title: "Risikoklassifizierung pro System"
    text: "Jedes System wird in eine der vier Klassen eingeordnet. Verbotene Praktiken werden sofort gestoppt, Hochrisiko-KI bekommt den vollen Pflichtenkatalog, Systeme mit Transparenzpflicht nach Artikel 50 werden gekennzeichnet, minimale Risiken dokumentiert."
  - title: "Pflicht-Dokumente erstellen"
    text: "Für Hochrisiko-Systeme: Risikomanagement-System, technische Dokumentation nach Annex IV, Konformitätsbewertung, Human-Oversight-Konzept, Logging-Spezifikation. Für Transparenzpflicht: Kennzeichnung von KI-Interaktionen gegenüber Kunden und Mitarbeitern. Für alle: KI-Kompetenz-Nachweis nach Artikel 4."
  - title: "Governance im Alltag verankern"
    text: "Eine sechs- bis achtseitige Richtlinie, die Rollen und Eskalationswege regelt. Quartalsweise Überprüfung im Geschäftsführungs-Jour-Fixe. Kein eigenes KI-Board, aber eine klare Rolle pro Thema: Datenschutz, Technik, Fachbereich, Geschäftsführung."
faq:
  - question: "Ab wann greifen welche Pflichten der EU-KI-Verordnung?"
    answer: "Die Verordnung ist am 1. August 2024 in Kraft getreten. Seit 2. Februar 2025 sind verbotene Praktiken nach Artikel 5 und die KI-Kompetenz-Pflicht nach Artikel 4 aktiv. Seit 2. August 2025 gelten die GPAI-Pflichten nach Kapitel V und das Sanktionsregime nach Artikel 99. Ab 2. August 2026 greifen die vollen Pflichten für Hochrisiko-KI nach Anhang III, dazu gehören Recruiting, Kredit-Scoring, Mitarbeiter-Performance-Bewertung. Ab 2. August 2027 gelten die Regeln für Hochrisiko-KI als Sicherheitskomponente nach Anhang I."
  - question: "Was sind die vier Risikoklassen und welche gelten im Mittelstand?"
    answer: "Klasse 1 unzulässig: Social Scoring, manipulative Systeme, Emotionserkennung am Arbeitsplatz. Klasse 2 hochrisiko: Recruiting-KI, Kredit-Scoring, Mitarbeiter-Performance-Bewertung, biometrische Zugangskontrolle. Klasse 3 begrenzt: Kunden-Chatbots, KI-generierte Bilder und Texte, Deepfakes, alle mit Kennzeichnungspflicht nach Artikel 50. Klasse 4 minimal: Spam-Filter, Rechtschreibprüfung, Recommender ohne Profiling. Im typischen Mittelstand finden wir Klasse 2 bei HR und Finance, Klasse 3 bei Marketing und Service, Klasse 4 flächendeckend."
  - question: "Wie hoch sind die Strafen bei einem Verstoß?"
    answer: "Drei Stufen nach Artikel 99. Verstöße gegen verbotene Praktiken nach Artikel 5 bis zu 35 Millionen Euro oder 7 Prozent des weltweiten Jahresumsatzes, jeweils der höhere Betrag. Andere Verstöße gegen Anbieter- oder Betreiberpflichten bis zu 15 Millionen Euro oder 3 Prozent. Falsche oder irreführende Informationen an Behörden bis zu 7,5 Millionen Euro oder 1 Prozent. Für KMU gilt jeweils der niedrigere Betrag."
  - question: "Wer ist in Deutschland die zuständige Marktaufsichtsbehörde?"
    answer: "Nach aktuellem Stand des KI-Marktaufsichts-Gesetzes von BMWK und BMJ übernimmt die Bundesnetzagentur die Rolle der zentralen Marktüberwachungsbehörde und Koordinierungsstelle. Das BSI ist für die Cybersecurity-Anforderungen an KI zuständig. Die BfDI bleibt Aufsicht für KI in Strafverfolgung und Migration. Für betroffene KMU heißt das: Die Bundesnetzagentur ist die erste Anlaufstelle für formale Nachfragen und Audits."
  - question: "Wird die Einführung eines KI-Governance-Rahmens gefördert?"
    answer: "Ja. Die Beratung zur Einführung eines KI-Governance-Rahmens fällt unter das BAFA-Programm Unternehmerisches Know-how. 50 Prozent Zuschuss auf die Beratungskosten, in strukturschwachen Regionen bis zu 80 Prozent. Bei einem Honorar von 3.500 Euro netto zahlen Sie effektiv 1.750 Euro. ST Strategieberatung ist BAFA-gelisteter Berater und übernimmt die Antragstellung vor Beratungsbeginn."
sources:
  - name: "EUR-Lex – Verordnung (EU) 2024/1689 (KI-Verordnung)"
    url: "https://eur-lex.europa.eu/eli/reg/2024/1689/oj"
  - name: "EU-Kommission – Regulatory Framework for AI"
    url: "https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai"
  - name: "Bundesnetzagentur – Künstliche Intelligenz"
    url: "https://www.bundesnetzagentur.de/DE/Fachthemen/KuenstlicheIntelligenz/start.html"
  - name: "BSI – Künstliche Intelligenz"
...
| Klasse | Rechtsgrundlage | Typische KMU-Beispiele | Pflichten |
|---|---|---|---|
| Unzulässig | Art. 5 | Emotionserkennung bei Mitarbeitern, Social Scoring von Kunden | sofort stoppen |
| Hochrisiko | Art. 6 + Anhang III | Recruiting-KI, Kredit-Scoring, Performance-Bewertung | voller Pflichtenkatalog |
| Begrenzt | Art. 50 | Chatbots, KI-generierte Texte und Bilder, Deepfakes | Transparenz und Kennzeichnung |
| Minimal | implizit | Spam-Filter, Rechtschreibprüfung | gute Praxis |
...
> "Die EU-KI-Verordnung ist kein Papiertiger. 35 Millionen Euro Strafrahmen meint die Kommission ernst. Wer heute ein KI-Register hat, wird im Audit verteidigungsfähig."
...
[Kostenloses Erstgespräch buchen](https://calendly.com/st-automatisierung-info/30min)
